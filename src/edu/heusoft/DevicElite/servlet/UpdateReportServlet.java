...
import edu.heusoft.DevicElite.common.DateUtil;
...
public class UpdateReportServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("self.location='/DevicElite/Service/z-querycheckout.jsp';");
...
//		out.println("javascript :history.back(-1);");
		out.println("self.location='/DevicElite/Service/addReport.jsp';");
