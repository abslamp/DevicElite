				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/FinanceIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li><a href="/DevicElite/Finance/QueryPrice.jsp"><i class="fa fa-table"></i><span class="text"> 结算信息</span></a></li>
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
								...
								<form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryPriceServlet"  method="POST"  >
									<div class="form-group pull-right" >
										&nbsp;&nbsp;&nbsp;<button class="btn btn-primary">查询</button>
									</div>    							
								</form>
								
								<form action="/DevicElite/servlet/QueryPriceServlet" method="post">
