...
<body>
	...
	<div class="container-fluid content">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/EngineerIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li class="opened">
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> 任务管理</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DevicElite/Engineer/QueryRepairRecord.jsp"><i class="fa fa-car"></i><span class="text"> 查询任务</span></a></li>
									<li><a href="/DevicElite/Engineer/UpdateRepairRecord.jsp"><i class="fa fa-envelope"></i><span class="text"> 跟进任务</span></a></li>
								</ul>	
							</li>
							<li>
								<a href="#"><i class="fa fa-list-alt"></i><span class="text"> 备件申报</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DevicElite/Engineer/QueryPart.jsp"><i class="fa fa-indent"></i><span class="text"> 查询备件</span></a></li>
									<li><a href="/DevicElite/Engineer/AddPartDetail.jsp"><i class="fa fa-tags"></i><span class="text"> 申请备件</span></a></li>
								</ul>
							</li>
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询任务信息</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryRepairRecordServiceManServlet"  method="POST"  >
                            <div class="form-group col-md-4">
                                <label class="control-label">维修人员编号</label>
                                <input type="text" class="form-control" value="${loginNo}" name="repair_person_no" readonly="readonly" />
                            </div> 
							<br/>
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
									...
									<tbody>
										<c:forEach items="${data}" var="u">
											<tr>
												...
												<td>${u.repair_person_no}</td>
												<td>${u.repair_time}</td>
												<td>${u.test_record}</td>
												<td>${u.repair_record}</td>
												<td>${u.repair_test_time}</td>
												<td>${u.work_amount}</td>
												<td>${u.person_price}</td>
												<td>${u.material_price}</td>
												<td>${u.repair_promise}</td>
												<td>${u.attention}</td>
												<td>${u.repair_status}</td>
												<td>${u.repair_delay}</td>
												<td>
													<a href="/DevicElite/Engineer/UpdateRepairRecord.jsp?repair_record_no=${u.repair_record_no}">
								...
								<form action="/DevicElite/servlet/QueryRepairRecordServiceManServlet" method="post">
									<input type="hidden" name="repair_record_no" value="${param.repair_record_no }" />
									<input type="hidden" name="repair_person_no" value="${param.repair_person_no }" />
									<input type="hidden" name="repair_time" value="${param.repair_time }" />
									<input type="hidden" name="test_record" value="${param.test_record }" />
									<input type="hidden" name="repair_record" value="${param.repair_record }" />
									<input type="hidden" name="repair_test_time" value="${param.repair_test_time }" />
									<input type="hidden" name="work_amount" value="${param.work_amount }" />
									<input type="hidden" name="person_price" value="${param.person_price }" />
									<input type="hidden" name="material_price" value="${param.material_price }" />
									<input type="hidden" name="repair_promise" value="${param.repair_promise }" />
									<input type="hidden" name="attention" value="${param.attention }" />
									<input type="hidden" name="repair_status" value="${param.repair_status }" />
									<input type="hidden" name="repair_delay" value="${param.repair_delay }" />
