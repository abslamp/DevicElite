...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>备件申请表</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>申请信息</strong></h2>
                        ...
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/AddPartDetailServiceManServlet"  method="POST"  >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" value="${param.part_no}" name="part_no">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">维修记录编号</label>
                                <input type="text" class="form-control" value="" name="repair_record_no">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">备件数量</label>
                                <input type="text" class="form-control" value="" name="part_detail_num">
                            </div>	
