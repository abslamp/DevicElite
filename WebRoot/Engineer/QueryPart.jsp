...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询备件信息</h3>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryPartServiceManServlet"  method="POST"  >
                            <div class="form-group col-md-4">
                                <label class="control-label">备件名称</label>
                                <input type="text" class="form-control" value="" name="part_name">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">备件型号</label>
                                <input type="text" class="form-control" value="" name="part_size">
                            </div>	
							<br/>
							...
							<tbody>
								<c:forEach items="${data}" var="u">
									<tr>
										...
										<td>${u.part_price}</td>
										<td>${u.part_num}</td>
										<td>${u.part_warn_num}</td>
										<td>${u.part_status}</td>
										<td>
											<div class="form-actions">
												<a href="/DevicElite/Engineer/AddPartDetail.jsp?part_no=${u.part_no}">
													<button type="submit" class="btn btn-primary">申请备件</button>
												</a>
												<!-- <a href="/DevicElite/Enginner/AddPartDetail.jsp?part_no=${u.part_no}">
													<button type="submit" class="btn btn-primary">申请备件</button>
												</a> -->
											</div>
										</td>
								...
								<form  action="/DevicElite/servlet/QueryPartServiceManServlet"  method="POST"  >

                                    <input type="hidden" class="form-control" value="${param.part_no}" name="part_no">
                               
                                    <input type="hidden" class="form-control" value="${param.part_name}" name="part_name">
                        
                                    <input type="hidden" class="form-control" value="${param.part_size}" name="part_size">
                       
                                    <input type="hidden" class="form-control" value="${param.part_price}" name="part_price">
                       
                                    <input type="hidden" class="form-control" value="${param.part_num}" name="part_num">
                          
                                    <input type="hidden" class="form-control" value="${param.part_warn_num}" name="part_warn_num">
                                    
                                    <input type="hidden" class="form-control" value="${param.part_status}" name="part_status">
