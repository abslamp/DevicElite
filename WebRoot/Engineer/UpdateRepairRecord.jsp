...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>跟进维修任务</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>条件更新</strong></h2>
                  	...
                  	<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/UpdateRepairRecordServiceManServlet"  method="POST"  >
                            <div class="form-group col-md-4">
                                <label class="control-label">维修记录编号</label>
                                <input type="text" class="form-control" value="${param.repair_record_no}" name="repair_record_no">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">检测记录</label>
                                <input type="text" class="form-control" value="" name="test_record">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">维修记录</label>
                                <input type="text" class="form-control" value="" name="repair_record">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">维修检测时间</label>
                                <input type="date" class="form-control" value="" name="repair_test_time">
                            </div>	
                            <div class="form-group col-md-4">
                                <label class="control-label">工作量</label>
                                <input type="text" class="form-control" value="" name="work_amount">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">人工费</label>
                                <input type="text" class="form-control" value="" name="person_price">
                            </div>
                            <div class="form-group col-md-4" hidden="hidden">
                                <label class="control-label">材料费</label>
                                <input type="hidden" class="form-control" value="" name="material_price">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">报修承诺</label>
                                <input type="text" class="form-control" value="" name="repair_promise">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">注意事项</label>
                                <input type="text" class="form-control" value="" name="attention">
                            </div>
                            <div class="form-group col-md-4">
								<label class="control-label" for="selectError3">维修状态</label>
								<div class="controls">
									<select id="selectError3" class="form-control" name="repair_status">
										<option>已分配</option>
										<option>已维修</option>
										<option>撤销</option>
									</select>
                            ...
                            <div class="form-group col-md-4">
								<label class="control-label" for="selectError3">维修延迟状态</label>
								<div class="controls">
									<select id="selectError3" class="form-control" name="repair_delay">
										<option></option>
										<option>一般</option>
										<option>比较严重</option>
										<option>严重</option>
