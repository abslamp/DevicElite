		...
		<div class="main ">
			...
			<div class="row"  >
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/RuKuServlet"  method="POST"  >                        
                            <!-- get the param.no -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="part_no" type="text" class="form-control" value="${param.part_no}" name="part_inc_num">
                            </div>	
                            <div class="form-group col-md-4">
                                <label class="control-label">入库数量</label>

                                <input type="text" class="form-control" value="" name="part_inc_num">
                            </div>	
							<br/>
