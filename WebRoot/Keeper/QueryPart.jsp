				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/KeeperIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li class="opened">
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> 仓库管理</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DevicElite/Keeper/QueryPart.jsp"><i class="fa fa-car"></i><span class="text"> 查询库存</span></a></li>
									<li><a href="/DevicElite/Keeper/QueryPartDetail.jsp"><i class="fa fa-envelope"></i><span class="text"> 查看流水明细</span></a></li>
		...
		<div class="main ">
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryPartKeeperServlet"  method="POST"  >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="select" name="part_status" class="form-control" size="1" >
			...
			<div class="row"  >
					<div class="panel panel-default">
								...
								<tbody>
									<c:forEach items="${data}" var="u">
										<tr>
											...
											<td>${u.part_status}</td>
											<td>
												<a href="/DevicElite/Keeper/RuKu.jsp?part_no=${u.part_no}">
							...
							<form action="/DevicElite/servlet/QueryPartKeeperServlet" method="post">
