		...
		<div class="main ">
			...
			<div class="row">
					...
					<div class="panel-body">
							...
							<tbody>
								<c:forEach items="${data}" var="u">
									<tr>
										...
										<td>
											<a href="/DevicElite/servlet/ChuKuUpdatePartServlet?part_no=${u.part_no}&part_detail_num=${u.part_detail_num}&part_detail_no=${u.part_detail_no}">
					    ...
					    <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryPartDetailKeeperServlet"  method="POST"  >
				...
				<form action="/DevicElite/servlet/QueryPartDetailKeeperServlet" method="post">
