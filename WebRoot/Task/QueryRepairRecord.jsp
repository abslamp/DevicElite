...
<body>
	...
	<div class="container-fluid content">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/TaskIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li >
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> 任务管理</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DevicElite/Task/QueryRepairRecord.jsp"><i class="fa fa-car"></i><span class="text"> 查询报修单</span></a></li>
									<li><a href="/DevicElite/Task/QueryStaff.jsp"><i class="fa fa-envelope"></i><span class="text"> 查询工程师</span></a></li>
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询报修信息</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryRepairRecordTaskServlet"  method="POST"  >
							...
							<tbody>
								<c:forEach items="${data}" var="u">
									<tr>
										...
										<td>
											<a href="/DevicElite/Task/UpdateRepairRecord.jsp?repair_record_no=${u.repair_record_no}">
												<button type="submit" class="btn btn-primary">分配维修师</button>
											</a>
										</td>
									</tr>
								</c:forEach>
		...
		<!-- end: Content -->
		<br><br><br>
		<form action="/DevicElite/servlet/QueryRepairRecordTaskServlet" method="post">
