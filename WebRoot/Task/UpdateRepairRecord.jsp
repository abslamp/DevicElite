				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/TaskIndex.html"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li >
								...
								<ul class="nav sub">
									...
									<li><a href="/DevicElite/Task/UpdateRepairRecord.jsp"><i class="fa fa-envelope"></i><span class="text"> 分配任务</span></a></li>
								</ul>	
							</li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/UpdateRepairRecordTaskServlet"  method="POST"  >
