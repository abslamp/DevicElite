			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>工程师列表</strong></h2>
					...
					<div class="panel-body">
						...
						<!-- fenye over -->
					<br />
					<form action="/DevicElite/servlet/QueryStaffTaskServlet" method="post">
				...
				<form action="/DevicElite/servlet/QueryStaffTaskServlet" method="post">
					<input type="hidden" name="staff_no" value="${param.staffNo }" />
					<input type="hidden" name="staff_name" value="${param.staffName }" />
					<input type="hidden" name="staff_character" value="${param.staffCharacter }" />
