   ...
   <div class="sidebar-collapse">
				...
				<div class="sidebar-footer">					
					...
					<div class="copyright text-center">
						<small>Proton <i class="fa fa-coffee"></i> from <a href="http://www.cssmoban.com/" title="HEU" target="_blank">HEU</a></small>
					</div>					
				</div>	
</div>
<div class="mm-page">
  <div class="mm-page">
   ...
   <!-- PANEL BODY -->
          ...
          <form action="/DevicElite/servlet/AddPriceServlet" method="post"  class="form-horizontal ">
          ...
          <a href="javascript:goprint()" ><button class="btn btn-sm btn-primary" ><i class="fa fa-print"></i> 打印</button></a>
          </div>
...
function goprint(){
	...
	if(input[0].value==""){
		...
		window.open("/DevicElite/servlet/GenerateCheckServlet?no="+${param.no}+"&personcost="+input[0].value+"&matercost="+<%=partTotal.doubleValue() %>);
	}
