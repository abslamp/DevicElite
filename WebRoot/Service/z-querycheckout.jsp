    ...
    <div class="container-fluid content">
      <div class="row"> 
        ...
        <div class="main sidebar-minified" style="min-height: 337px;">
          ...
          <form action="/DevicElite/servlet/QueryCompletedTasksServlet" method="post"  class="form-horizontal ">
          ...
          <form action="/DevicElite/servlet/QueryCompletedTasksServlet" method="post">
...
<%
 ...
 %>
                    <tr>
                      ...
                      <td><a href="/DevicElite/servlet/EditPriceDetailServlet?no=<%=recordSet.get(i).getRepair_record_no() %>&date=<%=recordSet.get(i).getRepair_time().toString() %>"">
