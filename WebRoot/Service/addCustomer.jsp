...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>添加客户信息</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>添加客户</strong></h2>
                        </div>
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/AddCustomerServlet"  method="POST"  >
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="" name="customer_companyname">
                                </div>													
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="" name="customer_housephone">
                                </div>		
								<div class="form-group col-md-4">
								...
								<div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="" name="customer_postcode">
                                </div>					
								<div class="form-group col-md-3">
                                    <label class="control-label">添加日期</label>
                                    <input type="date" class="form-control" value="" name="customer_visittime">
                                </div>				
                                <div class="form-group col-md-3">
			...
			<div class="row">
					<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>添加结果</strong></h2>
								...
								<table class="table table-bordered table-striped table-condensed table-hover">
									...
									<tbody>
											<tr>
												...
												<td><a href="/DevicElite/servlet/DeleteCustomerServlet?customer_idno=${id}">×</a></td>
											</tr>
