			...
			<div class="sidebar ">
				...
				<div class="sidebar-collapse">
					<div class="sidebar-header t-center">
                        <span><img class="text-logo" src="/DevicElite/assets/img/logo1.png" style="width:100%;"></span>
                    </div>										
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/UpdateEquipServlet"  method="POST"  >
				                <div class="row">
												<div class="col-sm-5">
