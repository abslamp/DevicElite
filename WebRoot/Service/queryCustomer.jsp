			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>查询信息</strong></h2>
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/QueryCustomerServlet"  method="POST"  >
                                ...
                                <div class="form-group col-md-4">
									...
									<select class="form-control" id="ccmonth-w1" name="customer_character">
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
									...
									<tbody>
										<c:forEach items="${data}" var="u">
											<tr>
												...
												<td><a href="/DevicElite/Service/updateCustomer.jsp?customer_idno=${u.customer_idno}"><i class="fa fa-edit">&nbsp;</i></a></td>
												<td><a href="/DevicElite/servlet/DeleteCustomerServlet?customer_idno=${u.customer_idno}&flag=query">×</a></td>
											</tr>
										</c:forEach>
										                                   
									</tbody>
								</table>  
								<ul class="pagination" width="50%" id="queryResult" style="float:left;">
								...
								<form  action="/DevicElite/servlet/QueryCustomerServlet"  method="POST"  >
