...
<![endif]-->
		...
		<link href="/DevicElite/assets/plugins/editable/css/bootstrap-editable.css" rel="stylesheet">
...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<a href="/DevicElite/servlet/UpdateReportServlet?id=${id}" style="float: right ;" class="btn btn-success"><i class="fa  fa-thumbs-o-up"></i> 确认</a>
	...
	<script src="/DevicElite/assets/plugins/mockjax/jquery.mockjax.min.js"></script>
	<script src="/DevicElite/assets/plugins/editable/js/bootstrap-editable.min.js"></script>
	<script src="/DevicElite/assets/plugins/moment/moment.min.js"></script>
	<script src="/DevicElite/assets/plugins/editable/inputs-ext/typeaheadjs/typeaheadjs.min.js"></script>
	<script src="/DevicElite/assets/plugins/editable/inputs-ext/address/address.min.js"></script>
	<script src="/DevicElite/assets/plugins/select2/js/select2.min.js"></script>   
	...
	<script src="/DevicElite/assets/js/pages/form-x-editable-demo.js"></script>
	<script src="/DevicElite/assets/js/pages/form-x-editable.js"></script>
