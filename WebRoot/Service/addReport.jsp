...
<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div id="wizard1" class="wizard-type1">
								...
								<form class="form-horizontal" role="form" action="/DevicElite/servlet/AddReportServlet" method="post">
	...
	<script src="/DevicElite/assets/plugins/chosen/js/chosen.jquery.min.js"></script>
	<script src="/DevicElite/assets/plugins/autosize/jquery.autosize.min.js"></script>
	<script src="/DevicElite/assets/plugins/placeholder/jquery.placeholder.min.js"></script>
	<script src="/DevicElite/assets/plugins/wizard/jquery.bootstrap.wizard.min.js"></script>
	<script src="/DevicElite/assets/plugins/maskedinput/jquery.maskedinput.min.js"></script>
	...
	<script src="/DevicElite/assets/js/pages/form-wizard.js"></script>
