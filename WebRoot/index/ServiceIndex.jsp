							...
							<div class="todo-list">									
								...
								<ul id="todo-2" class="todo-list-tasks">
									...
									<li>
										...
										<span class="desc">有新客户到来时，录入新客户信息。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">客户需要维修设备时帮助完成并录入表格。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">客户设备维修完成后填写并提交结算表。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">客户要求注销时在后台删除用户信息。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">定时接收维修完的设备。</span> 
									</li>
