							...
							<div class="todo-list">									
								...
								<ul id="todo-2" class="todo-list-tasks">
									...
									<li>
										...
										<span class="desc">保证不恶意分配任务。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">保持各工程师任务均衡。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">督促工程师及时完成任务。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">若发现违纪现象及时上报。</span> 
									</li>
