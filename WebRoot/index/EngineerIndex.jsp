							...
							<div class="todo-list">									
								...
								<ul id="todo-2" class="todo-list-tasks">
									<li>
										...
										<span class="desc">从客服处领取报修设备。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">录入检测结果和维修记录。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">需要备件时申请备件等待报批。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">备件批准后去仓库领取。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">遇到备件缺货的状况请耐心等待。</span> 
									</li>
									<li>
										<label class="custom-checkbox-item pull-left">
											<input class="custom-checkbox" type="checkbox"/>
										...
										<span class="desc">定时将维修完的设备送回客服。</span> 
									</li>
