...
<body>
	...
	<div class="container-fluid content">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DevicElite/index/BossIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li><a href="/DevicElite/Boss/queryCustomer.jsp"><i class="fa fa-table"></i><span class="text"> 查询客户信息</span></a></li>
							<li><a href="/DevicElite/Boss/QueryRepairRecord.jsp"><i class="fa fa-table"></i><span class="text"> 查询维修任务</span></a></li>
							<li><a href="/DevicElite/Boss/QueryPart.jsp"><i class="fa fa-table"></i><span class="text"> 查询库存</span></a></li>
							<li><a href="/DevicElite/Boss/QueryPrice.jsp"><i class="fa fa-table"></i><span class="text"> 查询结算信息</span></a></li>
						</ul>
					</div>					
				</div>
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询客户信息</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/BossQueryCustomerServlet"  method="POST"  >
                                <div class="form-group col-md-4">
                                    <label class="control-label">身份证</label>
                                    <input type="text" class="form-control" value="" name="customer_idno">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label">联系人</label>
                                    <input type="text" class="form-control" value="" name="customer_linkman">
                                </div>								
                                <div class="form-group col-md-4">
                                    <label class="control-label">电话号码</label>
                                    <input type="text" class="form-control" value="" name="customer_mobilephone">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="" name="customer_character">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label">电子邮箱</label>
                                    <input type="email" class="form-control" value="" name="customer_email">
                                </div>								
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
								<table class="table table-bordered table-striped table-condensed table-hover">
									...
									<tbody>
										<c:forEach items="${data}" var="u">
											<tr>
												<td>${u.customer_idno}</td>
												<td>${u.customer_linkman}</td>
												<td>${u.customer_mobilephone}</td>
												<td>${u.customer_address}</td>
												<td>${u.customer_email}</td>
												<td>${u.customer_companyname}</td>
												<td>${u.customer_character}</td>
											</tr>
										</c:forEach>
										                                   
									</tbody>
								</table>  
								<ul class="pagination" width="50%" id="queryResult" style="float:right;">
									<c:if test="${currentPage!=1}">
										<li> <a href="javascript:goPagePrev('${currentPage}')">上一页</a> </li>
									</c:if>
									<c:forEach begin="1" end="${pages}" var="pos">
										<c:if test="${pos==currentPage}">
											<li class="active"> <a href="javascript:goPage('${pos}')">${pos}</a> </li>
										</c:if>
										<c:if test="${pos!=currentPage}">
											<li> <a href="javascript:goPage('${pos}')">${pos}</a> </li>
										</c:if>
									</c:forEach>
								...
								<form  action="/DevicElite/servlet/BossQueryCustomerServlet"  method="POST"  >

                                    <input type="hidden" class="form-control" value="${param.customer_idno}" name="customer_idno">
                               
                                    <input type="hidden" class="form-control" value="${param.customer_linkman}" name="customer_linkman">
                        
                                    <input type="hidden" class="form-control" value="${param.customer_mobilephone}" name="customer_mobilephone">
                       
                                    <input type="hidden" class="form-control" value="${param.customer_address}" name="customer_address">
                       
                                    <input type="hidden" class="form-control" value="${param.customer_character}" name="customer_character">
                          
                                    <input type="hidden" class="form-control" value="${param.customer_email}" name="customer_email">
	...
	<!-- end: JavaScript-->
	<script>
		window.onload = document.getElementById('queryResult').scrollIntoView();
	</script>
