...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询维修信息</h3>
				</div>
			</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        <div class="panel-heading">
                            <h2><i class="fa fa-heart-o red"></i><strong>查询维修单</strong></h2>
                        ...
                        <div class="panel-body">
                                                 <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/BossQueryRepairRecordTaskServlet"  method="POST"  >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <!-- <input type="text" class="form-control" value="${param.repair_status}" name="repair_status"> -->
                            </div>
                        ...
                        <form action="/DevicElite/servlet/BossQueryRepairRecordTaskServlet"  method="POST"  >
