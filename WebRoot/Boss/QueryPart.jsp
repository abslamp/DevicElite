...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-heart-o"></i>查询入库信息</h3>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/BossQueryPartKeeperServlet"  method="POST"  >
                            <!-- <div class="form-group col-md-4">
                                <label class="control-label">备件编号</label>
                                <input type="text" class="form-control" value="" name="part_no">
                            </div> -->
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" value="" name="part_price">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">数量</label>
                                <input type="text" class="form-control" value="" name="part_num">
                            </div>	
                            <!-- <div class="form-group col-md-4">
                                <label class="control-label">警戒数量</label>
                                <input type="text" class="form-control" value="" name="part_warn_num">
                            </div> -->
                            <div class="form-group col-md-4">
                                <label class="control-label">库存状态</label>
                                <input type="text" class="form-control" value="" name="part_status">
                            </div>	
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<form action="/DevicElite/servlet/BossQueryPartKeeperServlet" method="post">
								<input type="hidden" name="part_no" value="${param.part_no }" />
								<input type="hidden" name="part_name" value="${param.part_name }" />
								<input type="hidden" name="part_size" value="${param.part_size }" />
								<input type="hidden" name="part_price" value="${param.part_price }" />
								<input type="hidden" name="part_num" value="${param.part_num }" />
								<input type="hidden" name="part_warn_num" value="${param.part_warn_num }" />
								<input type="hidden" name="part_status" value="${param.part_status }" />
