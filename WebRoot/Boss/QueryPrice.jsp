			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
								...
								<form class="form-vertical hover-stripped" role="form"  action="/DevicElite/servlet/BossQueryPriceServlet"  method="POST"  >
									<div class="form-group pull-right" >
										&nbsp;&nbsp;&nbsp;<button class="btn btn-primary">查询</button>
									</div>    							
								</form>
								
								<form action="/DevicElite/servlet/BossQueryPriceServlet" method="post">
									<input type="hidden" name="staff_no" value="${param.price_no }" />
									<input type="hidden" name="staff_name" value="${param.price_time }" />
									<input type="hidden" name="staff_character" value="${param.price }" />
